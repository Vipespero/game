...
return new class extends Migration
{
    ...
    private function seedDefaults(): void
    {
        $items = [
            ...
            [11, 'Estrella', 'star', 'maria.png', 510, 128],
            [12, 'Cometa', 'comet', 'Fresa.png', 706, 178],
            [13, 'Nube', 'cloud', 'maria.png', 958, 240],
            [14, 'Campana', 'bell', 'Fresa.png', 1278, 320],
            [15, 'Cupcake', 'cupcake', 'maria.png', 1680, 420],
            [16, 'Diamante', 'diamond', 'Fresa.png', 2182, 546],
            [17, 'Jardin', 'garden', 'maria.png', 2804, 702],
            [18, 'Sueño', 'dream', 'Fresa.png', 3570, 892],
            [19, 'Reino', 'kingdom', 'maria.png', 4508, 1128],
            [20, 'Final', 'final', 'Fresa.png', 5650, 1412],
        ];
