...
class MergeItemSeeder extends Seeder
{
    public function run(): void
    {
        $items = [
            ...
            [7, 'Tesoro', 'gem', 'maria.png', 'linear-gradient(145deg, #8be5ff, #9d77ff 55%, #ff86c9)', '18px', 94, 0, 0, 108, 28],
            [8, 'Castillo', 'castle', 'Fresa.png', 'linear-gradient(145deg, #8be5ff, #9d77ff 55%, #ff86c9)', '18px', 92, 0, 2, 166, 42],
