...
export const fallbackMissions: MissionDefinition[] = [
    {
        id: 'merge-20',
        label: 'Fusiona 20 objetos',
        progressKey: 'merge_count',
        goal: 20,
        reward: { hearts: 80, energy: 10 },
    },
    {
        id: 'album-5',
        label: 'Colecciona 5 cartas',
        progressKey: 'collected_cards',
        goal: 5,
        reward: { hearts: 120, energy: 15 },
    },
    {
        id: 'hearts-500',
        label: 'Guarda 500 corazones',
        progressKey: 'hearts',
        goal: 500,
        reward: { hearts: 160, energy: 0 },
    },
];
...
export const mergeChain: MergeItemSource[] = [
    {
        ...
        name: 'Corona',
        symbol: 'crown',
        imagePath: 'pochaco.png',
        backgroundStyle:
            'linear-gradient(145deg, #fff4c7, #ffbd59 52%, #ff8a3d)',
        borderRadius: '50%',
        imageSize: 106,
        imageOffsetX: 0,
        imageOffsetY: 4,
    ...
    },
    {
        ...
        name: 'Flor',
        symbol: 'flower',
        imagePath: 'pompompurin.png',
        backgroundStyle: 'linear-gradient(145deg, #ffe79d, #ffba54)',
        borderRadius: '50%',
        imageSize: 88,
        imageOffsetX: 0,
        imageOffsetY: 0,
    ...
    },
    {
        ...
        imagePath: 'Fresa.png',
        backgroundStyle:
            'linear-gradient(145deg, #c9ff9c, #ff8ab3 50%, #e32266)',
        borderRadius: '50%',
        imageSize: 110,
        imageOffsetX: 0,
        imageOffsetY: 3,
    ...
    },
    {
        ...
        name: 'Peluche',
        symbol: 'plush',
        imagePath: 'cinamoom.png',
        backgroundStyle: 'linear-gradient(145deg, #d8f4ff, #76cbff)',
        borderRadius: '50%',
        imageSize: 92,
        imageOffsetX: 0,
        imageOffsetY: 4,
    ...
    },
    {
        ...
        name: 'Lazo',
        symbol: 'bow',
        imagePath: 'bibble.png',
        backgroundStyle:
            'linear-gradient(145deg, #f7c4ff, #b56cff 52%, #7c4dff)',
        borderRadius: '50%',
        imageSize: 104,
        imageOffsetX: 0,
        imageOffsetY: 2,
    ...
    },
    {
        ...
        name: 'Semilla',
        symbol: 'seed',
        imagePath: 'Melody1.png',
        backgroundStyle: 'linear-gradient(145deg, #ff9696, #e73b3b)',
        borderRadius: '50%',
        imageSize: 86,
        imageOffsetX: 0,
        imageOffsetY: 8,
    ...
    },
    {
        ...
        imagePath: 'maria.png',
        backgroundStyle:
            'linear-gradient(145deg, #ffc1dc, #9d4edd 55%, #35235f)',
        borderRadius: '50%',
        imageSize: 118,
        imageOffsetX: 0,
        imageOffsetY: 5,
    ...
    },
    {
        ...
        name: 'Ramo',
        symbol: 'bouquet',
        imagePath: 'Mymelodyrosa.png',
        backgroundStyle: 'linear-gradient(145deg, #ffd8ee, #ff74b8)',
        borderRadius: '50%',
        imageSize: 76,
        imageOffsetX: 0,
        imageOffsetY: 6,
    ...
    },
    {
        ...
        name: 'Palacio',
        symbol: 'palace',
        imagePath: 'Gengar.png',
        backgroundStyle:
            'linear-gradient(145deg, #d9b4ff, #8b5cf6 52%, #4c1d95)',
        borderRadius: '50%',
        imageSize: 116,
        imageOffsetX: 0,
        imageOffsetY: 2,
    ...
    },
    {
        ...
        imagePath: null,
        backgroundStyle:
            'linear-gradient(145deg, #fef3ff, #a5d8ff 52%, #f0abfc)',
        borderRadius: '50%',
        imageSize: 100,
        imageOffsetX: 0,
        imageOffsetY: 0,
    ...
    },
    {
        ...
        imagePath: null,
        backgroundStyle:
            'linear-gradient(145deg, #fff0a6, #ffbd59 52%, #ff7ab6)',
        borderRadius: '50%',
        imageSize: 100,
        imageOffsetX: 0,
        imageOffsetY: 0,
    ...
    },
    {
        ...
        imagePath: null,
        backgroundStyle:
            'linear-gradient(145deg, #ffd6e8, #ff8cc6 52%, #b794f4)',
        borderRadius: '50%',
        imageSize: 100,
        imageOffsetX: 0,
        imageOffsetY: 0,
    ...
    },
    {
        ...
        imagePath: null,
        backgroundStyle:
            'linear-gradient(145deg, #9ff3ff, #77a7ff 52%, #d68cff)',
        borderRadius: '50%',
        imageSize: 100,
        imageOffsetX: 0,
        imageOffsetY: 0,
    ...
    },
    {
        ...
        imagePath: null,
        backgroundStyle:
            'linear-gradient(145deg, #c7ffd8, #72d6a4 52%, #ff99cf)',
        borderRadius: '50%',
        imageSize: 100,
        imageOffsetX: 0,
        imageOffsetY: 0,
    ...
    },
    {
        ...
        imagePath: null,
        backgroundStyle:
            'linear-gradient(145deg, #d7c6ff, #8b5cf6 52%, #ff8cc6)',
        borderRadius: '50%',
        imageSize: 100,
        imageOffsetX: 0,
        imageOffsetY: 0,
    ...
    },
    {
        ...
        imagePath: null,
        backgroundStyle:
            'linear-gradient(145deg, #ffe7a8, #ff87c2 48%, #7dd3fc)',
        borderRadius: '50%',
        imageSize: 100,
        imageOffsetX: 0,
        imageOffsetY: 0,
    ...
    },
    {
        ...
        imagePath: null,
        backgroundStyle:
            'linear-gradient(145deg, #fff1a8, #ff78bd 42%, #8b5cf6 72%, #65d7ff)',
        borderRadius: '50%',
        imageSize: 100,
        imageOffsetX: 0,
        imageOffsetY: 0,
...
export const getLevel = (level: number, items: MergeItemDefinition[]) =>
    ...
    (items[
        Math.min(Math.max(level, 1), items.length) - 1
    ] as MergeItemDefinition);
...
export const xpForLevel = (level: number) =>
    Math.round(60 + (level - 1) * 110 + Math.pow(level - 1, 2) * 35);

export const fallbackPlayerLevels: PlayerLevelDefinition[] = Array.from(
    { length: 100 },
    (_, index) => ({
        level: index + 1,
...
export const fallbackMergeItems: MergeItemDefinition[] = mergeChain.map(
    (item) => ({
        ...item,
...
export const chooseCard = (cardPool: MelodyCard[]): MelodyCard | null => {
    ...
    const totalWeight = activeCards.reduce(
        (total, card) => total + Math.max(card.dropWeight, 1),
        0,
    );
...
export const dailyMessages = [
    ...
    'Cada día agradezco por tenerte en mi vida.',
    ...
    'Me inspiré en ti para crear este juego.',
...
export const splashMessages = [
    'Este juego es un rinconcito hecho para ti, para recordarte que eres amada, fuerte y capaz de llenar cualquier día de luz.',
    'Antes de empezar, respira: todo aquí fue pensado para sacarte una sonrisa y acompañarte un ratito bonito.',
    'Que esta partida te recuerde lo especial que eres, incluso en los días en que se te olvida mirar todo lo que vales.',
    'Bienvenida a tu casita: un lugar pequeño, dulce y lleno de detalles para decirte que siempre voy a elegirte.',
    'Cada corazón, cada carta, cada fusión fue creada con todo mi amor para ti.',
    'Este rinconcito es solo nuestro: un mundo pequeño donde todo está pensado para hacerte sonreír.',
];
...
export const getSplashMessage = (): string => {
    ...
    return (
        splashMessages[dayOfYear % splashMessages.length] ?? splashMessages[0]
    );
};
