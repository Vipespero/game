...
const mergeChain: MergeItemSource[] = [
    ...
    { level: 6, name: 'Corona', symbol: 'crown', imagePath: 'pochaco.png', backgroundStyle: 'linear-gradient(145deg, #fff4c7, #ffbd59 52%, #ff8a3d)', borderRadius: '50%', imageSize: 106, imageOffsetX: 0, imageOffsetY: 4, xp: 68, hearts: 18, isActive: true },
    { level: 7, name: 'Tesoro', symbol: 'gem', imagePath: 'maria.png', backgroundStyle: 'linear-gradient(145deg, #ffc1dc, #9d4edd 55%, #35235f)', borderRadius: '50%', imageSize: 128, imageOffsetX: 0, imageOffsetY: 12, xp: 108, hearts: 28, isActive: true },
    { level: 8, name: 'Castillo', symbol: 'castle', imagePath: 'Fresa.png', backgroundStyle: 'linear-gradient(145deg, #c9ff9c, #ff8ab3 50%, #e32266)', borderRadius: '50%', imageSize: 110, imageOffsetX: 0, imageOffsetY: 3, xp: 166, hearts: 42, isActive: true },
    { level: 9, name: 'Palacio', symbol: 'palace', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #f8b7ff, #8b5cf6 55%, #65d7ff)', borderRadius: '18px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 248, hearts: 62, isActive: true },
    { level: 10, name: 'Legendario', symbol: 'rainbow', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #ffe66d, #ff78bd 52%, #8b5cf6)', borderRadius: '18px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 360, hearts: 90, isActive: true },
    { level: 11, name: 'Estrella', symbol: 'star', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #fff1a8, #ff7ab6 55%, #9d77ff)', borderRadius: '20px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 510, hearts: 128, isActive: true },
    { level: 12, name: 'Cometa', symbol: 'comet', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #b8f4ff, #7c83ff 52%, #ff92d0)', borderRadius: '20px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 706, hearts: 178, isActive: true },
    { level: 13, name: 'Nube', symbol: 'cloud', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #fef3ff, #a5d8ff 52%, #f0abfc)', borderRadius: '22px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 958, hearts: 240, isActive: true },
    { level: 14, name: 'Campana', symbol: 'bell', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #fff0a6, #ffbd59 52%, #ff7ab6)', borderRadius: '22px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 1278, hearts: 320, isActive: true },
    { level: 15, name: 'Cupcake', symbol: 'cupcake', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #ffd6e8, #ff8cc6 52%, #b794f4)', borderRadius: '24px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 1680, hearts: 420, isActive: true },
    { level: 16, name: 'Diamante', symbol: 'diamond', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #9ff3ff, #77a7ff 52%, #d68cff)', borderRadius: '24px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 2182, hearts: 546, isActive: true },
    { level: 17, name: 'Jardin', symbol: 'garden', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #c7ffd8, #72d6a4 52%, #ff99cf)', borderRadius: '26px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 2804, hearts: 702, isActive: true },
    { level: 18, name: 'Sueño', symbol: 'dream', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #d7c6ff, #8b5cf6 52%, #ff8cc6)', borderRadius: '26px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 3570, hearts: 892, isActive: true },
    { level: 19, name: 'Reino', symbol: 'kingdom', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #ffe7a8, #ff87c2 48%, #7dd3fc)', borderRadius: '28px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 4508, hearts: 1128, isActive: true },
    { level: 20, name: 'Final', symbol: 'final', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #fff1a8, #ff78bd 42%, #8b5cf6 72%, #65d7ff)', borderRadius: '28px', imageSize: 86, imageOffsetX: 0, imageOffsetY: 0, xp: 5650, hearts: 1412, isActive: true },
];
