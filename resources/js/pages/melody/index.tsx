...
const mergeChain: MergeItemSource[] = [
    ...
    { level: 7, name: 'Tesoro', symbol: 'gem', imagePath: 'maria.png', backgroundStyle: 'linear-gradient(145deg, #8be5ff, #9d77ff 55%, #ff86c9)', borderRadius: '18px', imageSize: 94, imageOffsetX: 0, imageOffsetY: 0, xp: 108, hearts: 28, isActive: true },
    { level: 8, name: 'Castillo', symbol: 'castle', imagePath: 'Fresa.png', backgroundStyle: 'linear-gradient(145deg, #8be5ff, #9d77ff 55%, #ff86c9)', borderRadius: '18px', imageSize: 92, imageOffsetX: 0, imageOffsetY: 2, xp: 166, hearts: 42, isActive: true },
