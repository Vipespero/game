...
const mergeChain: MergeItemSource[] = [
    ...
    { level: 7, name: 'Tesoro', symbol: 'gem', imagePath: 'maria.png', backgroundStyle: 'linear-gradient(145deg, #1f1530, #9d4edd 52%, #ff86c9)', borderRadius: '22px', imageSize: 132, imageOffsetX: 0, imageOffsetY: 10, xp: 108, hearts: 28, isActive: true },
    { level: 8, name: 'Castillo', symbol: 'castle', imagePath: 'Fresa.png', backgroundStyle: 'linear-gradient(145deg, #b9ff8a, #ff6f9f 48%, #d81b60)', borderRadius: '50%', imageSize: 108, imageOffsetX: 0, imageOffsetY: 2, xp: 166, hearts: 42, isActive: true },
