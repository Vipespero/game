...
const mergeChain: MergeItemSource[] = [
    ...
    { level: 11, name: 'Estrella', symbol: 'star', imagePath: 'bibble.png', backgroundStyle: 'linear-gradient(145deg, #fff1a8, #ff7ab6 55%, #9d77ff)', borderRadius: '20px', imageSize: 94, imageOffsetX: 0, imageOffsetY: 0, xp: 510, hearts: 128, isActive: true },
    { level: 12, name: 'Cometa', symbol: 'comet', imagePath: 'pochaco.png', backgroundStyle: 'linear-gradient(145deg, #b8f4ff, #7c83ff 52%, #ff92d0)', borderRadius: '20px', imageSize: 92, imageOffsetX: 0, imageOffsetY: 2, xp: 706, hearts: 178, isActive: true },
    { level: 13, name: 'Nube', symbol: 'cloud', imagePath: 'bibble.png', backgroundStyle: 'linear-gradient(145deg, #fef3ff, #a5d8ff 52%, #f0abfc)', borderRadius: '22px', imageSize: 94, imageOffsetX: 0, imageOffsetY: 0, xp: 958, hearts: 240, isActive: true },
    { level: 14, name: 'Campana', symbol: 'bell', imagePath: 'pochaco.png', backgroundStyle: 'linear-gradient(145deg, #fff0a6, #ffbd59 52%, #ff7ab6)', borderRadius: '22px', imageSize: 92, imageOffsetX: 0, imageOffsetY: 2, xp: 1278, hearts: 320, isActive: true },
    { level: 15, name: 'Cupcake', symbol: 'cupcake', imagePath: 'bibble.png', backgroundStyle: 'linear-gradient(145deg, #ffd6e8, #ff8cc6 52%, #b794f4)', borderRadius: '24px', imageSize: 94, imageOffsetX: 0, imageOffsetY: 0, xp: 1680, hearts: 420, isActive: true },
    { level: 16, name: 'Diamante', symbol: 'diamond', imagePath: 'pochaco.png', backgroundStyle: 'linear-gradient(145deg, #9ff3ff, #77a7ff 52%, #d68cff)', borderRadius: '24px', imageSize: 92, imageOffsetX: 0, imageOffsetY: 2, xp: 2182, hearts: 546, isActive: true },
    { level: 17, name: 'Jardin', symbol: 'garden', imagePath: 'bibble.png', backgroundStyle: 'linear-gradient(145deg, #c7ffd8, #72d6a4 52%, #ff99cf)', borderRadius: '26px', imageSize: 94, imageOffsetX: 0, imageOffsetY: 0, xp: 2804, hearts: 702, isActive: true },
    { level: 18, name: 'Sueño', symbol: 'dream', imagePath: 'pochaco.png', backgroundStyle: 'linear-gradient(145deg, #d7c6ff, #8b5cf6 52%, #ff8cc6)', borderRadius: '26px', imageSize: 92, imageOffsetX: 0, imageOffsetY: 2, xp: 3570, hearts: 892, isActive: true },
    { level: 19, name: 'Reino', symbol: 'kingdom', imagePath: 'bibble.png', backgroundStyle: 'linear-gradient(145deg, #ffe7a8, #ff87c2 48%, #7dd3fc)', borderRadius: '28px', imageSize: 94, imageOffsetX: 0, imageOffsetY: 0, xp: 4508, hearts: 1128, isActive: true },
    { level: 20, name: 'Final', symbol: 'final', imagePath: 'pochaco.png', backgroundStyle: 'linear-gradient(145deg, #fff1a8, #ff78bd 42%, #8b5cf6 72%, #65d7ff)', borderRadius: '28px', imageSize: 92, imageOffsetX: 0, imageOffsetY: 2, xp: 5650, hearts: 1412, isActive: true },
];
