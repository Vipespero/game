...
const mergeChain: MergeItemSource[] = [
    ...
    { level: 9, name: 'Palacio', symbol: 'palace', imagePath: null, backgroundStyle: 'linear-gradient(145deg, #f8b7ff, #8b5cf6 55%, #65d7ff)', borderRadius: '50%', imageSize: 100, imageOffsetX: 0, imageOffsetY: 0, xp: 248, hearts: 62, isActive: true },
